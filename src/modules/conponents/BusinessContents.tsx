  ...
  return (
    <>
      <div className="border-t-2 border-b-2">
        ...
        >
          <div
            className={`lg:w-2/3 mx-auto opacity-0 ${inView && "opacity-100 animate-fade-left animate-once animate-duration-4000 animate-ease-out"}`}
          >
          ...
          {image && (
            <div
              className={`lg:w-1/3 shadow-lg opacity-0 ${inView && "opacity-100 animate-fade animate-once animate-duration-[3000ms] animate-ease-out"}`}
            >
              <div className="">
