        ...
        <div className="auto">
            <div className="mx-auto items-center w-4/5 min-w-48">
                ...
                <div className="lg:flex">
                    <div className="w-40"><label>企業名</label></div>
                    <div>
                        <input type="text" {...register("company")} placeholder="ここに入力"></input>
                    </div>
                </div>
                <div className="lg:flex">
                    <div className="w-40"><label>氏名</label></div>
                    <div>
                        <input className="w-48" type="text" {...register("name",{required:true})} placeholder="ここに入力"></input>
                        {errors.name && <ErrorMessage message="氏名を入力してください"/>}
                    </div>
                </div>
                <div className="lg:flex">
                    <div className="w-40"><label>電話番号</label></div>
                    <div>
                ...
                <div className="lg:flex">
                    <div className="w-40"><label>メールアドレス</label></div>
                    <div>
                ...
                <div className="lg:flex">
                    <div className="w-40"><label>お問い合わせ内容</label></div>
                    <div className="">
                        <select>
                            ...
                            <option value="美容医療SNS支援サービス「メディカルライアート」">美容医療SNS支援サービス「メディカルライアート」</option>
                            <option value="MEO対策">MEO対策</option>
                        </select>
                    </div>
                </div>
                <div className="lg:flex">
                    <div className="w-40"><label>備考</label></div>
                    <div className="w-2/3">
