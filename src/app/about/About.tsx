    ...
    <div className="mx-auto w-4/5">
        ...
        <div className="p-4 lg:p-8 bg-black text-white dark:invert flex flex-col">
            ...
            <div className="p-4 lg:p-8">
                ...
                <div className="px-0 lg:px-8 text-lg">
                    <p className="py-1">九州の福岡で生まれ育った我々エクセンドのメンバーは、上京し日本全国で活動するようになってから、</p>
                    <p className="py-1">自分たちでは当たり前だと思っていた『九州・福岡の文化・コミュニティ』などの素晴らしい価値があまりにも知られていないことを知りました。</p>
                    <p className="py-1">九州の観光地や食文化、歴史など他にはない素晴らしい価値を日本全国に広めるため、</p>
                    <p className="py-1">我々エクセンドが、価値を創出する地域の人々とその価値を受け取る日本全国の人々を繋ぐハブとして、</p>
                    <p className="py-1">動画マーケティングの知識・技術を通して、九州地方や福岡県の地域創生に貢献していきます。</p>
                </div>
            </div>
            {/* vision */}
            <div className="p-4 lg:p-8">
                ...
                <div className="px-0 lg:px-8 text-lg">
                    <p className="py-1">社名の由来『Exceed × End』であるように、我々はお客様や社会に価値提供するため、常に妥協せず全力で取り組み、</p>
        ...
        <div className="py-12">
            ...
            <div className="flex flex-col lg:flex-row">
                <Image className="rounded-full p-4" src="/images/園田拓真_宣材写真.webp" alt="about" width={400} height={400}/>
                <div className="lg:p-8">
                    <div className="flex text-xl font-bold py-4">
                        <div>代表　</div>
                        <div className="px-4">園田 拓真</div>
                    </div>
                    <div className="text-lg py-4">エクセンドは、地元である福岡県・九州地方を動画マーケティングの力で盛り上げ、日本中にさらなる価値を創出し盛り上げたいという理念のもと設立しました。
                    ...
                    <div className="flex">
                        ...
                        <div className="rounded-lg h-10 w-10 flex justify-center items-center m-1">
                            ...
                            <Image className="" src="/publicLogos/Facebook_blue_logo.svg" alt="facebook" width={44} height={44}/>
                            </a>
                        </div>
                        <div className="rounded-lg h-10 w-10 flex justify-center items-center m-1">
                            <a className="" href="https://www.instagram.com/takumarke?igsh=N3hkY3d4dnBkNzRr&utm_source=qr" target="_blank">
